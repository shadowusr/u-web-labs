...
HEREDOC;
        ...
        <div class="row">
            <div class="col-12" >
                ...
                <p data-aos="fade-up">Исходный код страницы доступен на <a href="https://github.com/shadowusr/u-web-labs/tree/master/resources/views/tasks/task-7-museums-search.php">GitHub</a>.</p>
            </div>
        </div>
    </div>
</section>
